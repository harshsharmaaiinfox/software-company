...
const ShopifyHero = () => {
    return (
        <section className="shopify-hero-area pt-150 pb-120 p-relative overflow-hidden"
            style={{
            ...
            <div className="container p-relative" style={{ zIndex: 1 }}>
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7">
                        <div className="shopify-content pr-50">
                            ...
                            <h1 className="wow fadeInUp" data-wow-delay=".4s" style={{
                                ...
                                Expert <span style={{ color: '#4eb985' }}>Shopify</span> Store <br /> Development
                            </h1>
                            <p className="wow fadeInUp" data-wow-delay=".6s" style={{
                                ...
                                Transform your e-commerce vision into a high-converting Shopify store with our expert design and development services.
                                We build scalable, high-performance stores that drive sales and delight your customers.
                            </p>

                            <div className="row mb-50 wow fadeInUp" data-wow-delay=".8s">
                                {[
                                    ['# Store Setup & Customization', '# Custom Shopify Apps'],
                                    ['# Shopify Theme Development', '# Shopify SEO Optimization'],
                                    ['# Migration to Shopify', '# 24/7 Store Support']
                                ].map((pair, idx) => (
                    ...
                    <div className="col-lg-5">
                        <div className="shopify-form wow fadeInRight" data-wow-delay=".6s" style={{
                            background: '#fff',
                            padding: '45px',
                            borderRadius: '30px',
                            ...
                            <h3 className="mb-35 text-center" style={{
                                ...
                                Want To Start Your Shopify Store?
                            </h3>
                            <form action="#">
                                <div className="mb-20">
            ...
            <style dangerouslySetInnerHTML={{
                ...
                @media (max-width: 991px) {
                    .shopify-hero-area { pt-100; pb-80; }
                    .shopify-content { pr-0; mb-60; text-align: center; }
                    .shopify-content h1 { font-size: 42px !important; }
                }
            `}} />
        </section>
    );
