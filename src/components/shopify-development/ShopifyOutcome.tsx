...
const ShopifyOutcome = () => {
    return (
        <section className="shopify-outcome-area pb-120 pt-100 p-relative overflow-hidden"
            style={{
                background: '#fff',
                    ...
                    <div className="col-lg-6">
                        <div className="outcome-content pl-50 wow fadeInRight" data-wow-delay=".5s">
                            ...
                            <Link to="/contact" className="tv-link-btn" style={{
                                background: 'linear-gradient(to right, #ff7442, #e91e63)',
                                color: '#fff',
                                padding: '15px 40px',
                                borderRadius: '50px',
                                fontWeight: '700',
