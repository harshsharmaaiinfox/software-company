const AndroidTestimonials = () => {
    ...
    return (
        <section className="android-testimonials-area pt-120 pb-120" style={{ background: '#fff' }}>
                    ...
                    <div className="col-lg-6">
                        <div className="testimonial-content-premium pr-50 wow fadeInLeft" data-wow-delay=".4s">
                            ...
                            <h2 style={{ color: '#036278', fontSize: '42px', fontWeight: '800', marginBottom: '30px', lineHeight: '1.2' }}>
                                What our clients say about <br /> our design
                            </h2>
                            ...
                            <div className="quote-box mb-40" style={{ position: 'relative', paddingLeft: '30px' }}>
                                ...
                                <p style={{
                                    ...
                                    "The Mangal Tech team has provided us with an incredible Android application.
                                    Their expertise in UI/UX and native performance is unmatched. Highly recommend!"
                                </p>
                            </div>
                            ...
                            <div className="d-flex align-items-center gap-15">
                                <div style={{
                                    ...
                                    <img src="/assets/img/team/team-1-1.png" alt="Client Avatar" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </div>
                                <div>
                                    <h4 style={{ color: '#036278', fontSize: '20px', fontWeight: '800', marginBottom: '2px' }}>Robert Fox</h4>
                                    <p style={{ color: '#585b6f', fontSize: '14px', margin: 0, fontWeight: '600' }}>CEO, Brand Studio</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <style dangerouslySetInnerHTML={{
                ...
                .ranking-premium-card:hover .rank-icon {
                    background: #036278;
                    color: #fff;
                    transform: scale(1.1);
                }
...
export default AndroidTestimonials;
